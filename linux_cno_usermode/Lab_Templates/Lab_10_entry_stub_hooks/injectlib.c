...
void on_load(void) {
	...
	udis_init();
	entry_stub_create(//TODO: fill out);
    entry_stub_hook(//TODO: fill out);
...
void patch_code(void* target, void* patch, unsigned long len) {
	...
	//TODO: you should be to grab the same function used in Lab_09
...
int entry_stub_create(entry_stub_t* stub, void* original) {
	...
	//TODO:
   	...
   	/* Back up the original bytes that we overwrote by placing them in the trampoline */
	//TODO:
...
int entry_stub_unhook(entry_stub_t* stub) {
	...
	//TODO: patch your code to unhook
